...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset ('assets/dist/img/logo-pu.jpg') }}">
  <title>Login | Dinas PUPR Tapin</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">

  <link rel="shortcut icon" href="<?= base_url() ?>/assets/dist/img/logo-pu.jpg">
  <!-- Font Awesome -->
  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="login-logo">
        <br>
        <h2 style="color:orange; font-family: Gill Sans, sans-serif;"><b>Dinas Pekerjaan Umum<br>Penataan Ruang <br> Kabupaten Tapin </b></h2>
        <h3>
          <img src="<?= base_url() ?>/assets/dist/img/logo-pu.jpg" style="margin-top: 20px; margin-bottom: 20px;" width="140px;" height="150px;">
      ...
      <div class="card-body login-card-body">
        ...
        <form action="" method="POST">
          ...
          <button type="submit" name="login" class="btn btn-warning btn-block btn-xm"><i class="fa fa-sign-in-alt mr-1"></i>Masuk</button>
          <br>
        </form>
