...
$id   = $_GET['id'];
$data = $koneksi->query("SELECT * FROM barang_masuk WHERE id_bm = '$id'");
...
<body class="hold-transition sidebar-mini layout-fixed">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control select2" data-placeholder="Pilih" id="id_jenis" name="id_jenis">
                                                    ...
                                                    ?>
                                                        <option value="<?= $dj['id_jenis'] ?>" <?php if ($dj['id_jenis'] == $row['id_jenis']) {
                                                                                                    echo "selected";
                                                                                                } ?>><?= $dj['jenis'] ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control select2" data-placeholder="Pilih" id="id_satuan" name="id_satuan">
                                                    ...
                                                    ?>
                                                        <option value="<?= $ds['id_satuan'] ?>" <?php if ($ds['id_satuan'] == $row['id_satuan']) {
                                                                                                    echo "selected";
                                                                                                } ?>><?= $ds['satuan'] ?></option>
                                                    <?php } ?>
                                                </select>
    ...
    if (isset($_POST['submit'])) {
        ...
        $submit = $koneksi->query("UPDATE barang_masuk SET  
