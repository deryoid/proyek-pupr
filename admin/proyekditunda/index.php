        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Proyek Yang Di Tunda</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <?php
                                            $no = 1;
                                            $data = $koneksi->query("SELECT * FROM proyek as p LEFT JOIN perusahaan as pr ON p.id_perusahaan = pr.id_perusahaan WHERE p.status_proyek = 'Di Tunda'");
                                            ...
                                            ?>
                                                <tbody style="background-color: azure">
                                                    <tr>
                                                        ...
                                                        <td><?= $row['estimasi'] ?></td>
                                                        <td align="center">
                                                            <?php if ($row['status_proyek'] == "Di Tunda") { ?>
