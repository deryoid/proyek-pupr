...
$id   = $_GET['id'];
$data = $koneksi->query("SELECT * FROM satuan WHERE id_satuan = '$id'");
...
<body class="hold-transition sidebar-mini layout-fixed">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Satuan Barang</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
    ...
    if (isset($_POST['submit'])) {
        ...
        $submit = $koneksi->query("UPDATE satuan SET  
                            satuan = '$satuan'
                            WHERE 
                            id_satuan = '$id'");

        if ($submit) {
            $_SESSION['pesan'] = "Data satuan Ditambahkan";
